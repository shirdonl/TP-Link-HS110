...
func (p *Hs110Plug) TurnOn() (err error) {
...
func (p *Hs110Plug) TurnOff() (err error) {
...
func (p *Hs110Plug) SystemInfo() (results string, err error) {
...
func (p *Hs110Plug) MeterInfo() (results string, err error) {
...
func (p *Hs110Plug) DailyStats(month int, year int) (results string, err error) {
...
func send(ip string, payload []byte) (data []byte, err error) {
	// 10 second timeout
	conn, err := net.DialTimeout("tcp", ip+":8888", time.Duration(10)*time.Second)
	if err != nil {
